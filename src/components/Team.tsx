...
const doctors = [
  {
    ...
    description: "Devenir dentiste était son objectif depuis l'âge de 8 ans. Minutieux, doux, à l'écoute et très pédagogue.",
  ...
  },
  {
    ...
    description: "Spécialiste en esthétique dentaire, il allie technicité et sens du détail.",
    parcours: [],
  },
  {
    name: "Dr. Emmanuelle Soussan",
    image: "/dr-femme-1.png",
    diploma: "Diplômée Paris 7 · DU Implantologie, St Louis",
  ...
  },
  {
    ...
    diploma: "Diplômée de Madrid · Master Dentisterie Pédiatrique",
    specialities: ["Dentisterie pédiatrique"],
    description: "Spécialisée dans les soins pour enfants, elle crée un environnement rassurant et bienveillant.",
    parcours: [],
  },
  {
    name: "Dr. Lucien Deloume",
    image: "/dr-homme-2.png",
    diploma: "Diplômé de Bordeaux · DU Implantologie, Gênes",
    specialities: ["Soins conservateurs", "Prothèses", "Implantologie", "Parodontologie"],
    description: "Rigoureux et polyvalent, il couvre un large spectre de soins dentaires.",
    parcours: [],
  },
];
